---
title: "sPlotOpen - Demo"
author: "Francesco Maria Sabatini"
date: "07/04/2021"
output: html_document
---

This demo illustrates how to import and manipulate sPlotOpen data to create some basic graphical or table outputs together with a reference list.    
<br>
...
```
There are `r length(plotlist.quercus)` plots containing at least a *Quercus* species.  
<br>
...
```{r, fig.width=8, fig.height=9, fig.align="center", warning=F, message=F, cache=T}
(Figure1a <- w3a + 
  geom_sf(data=header.quercus.sf, aes(color=Biome), pch=16, size=0.8, alpha=0.8) + # aes(col=Dataset),
...
```{r}
sPlotOpen_citation(IDs=plotlist.quercus, level="database", out.file = "_output/demo.bib")
