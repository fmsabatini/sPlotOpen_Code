...
```{r}
#Ancillary function to extract name initials
...
affiliations <- first %>% 
  ...
  bind_rows(allaffiliations %>% 
      ...
      bind_rows(allaffiliations %>% 
                  filter(Name=="Anita Smyth")) %>%
      bind_rows(allaffiliations %>% 
                  filter(Name=="Alireza Naqinezhad")) %>% 
  ## Add possible additional coauthors here
      bind_rows(allaffiliations %>% 
                  filter(Name=="Sylvia Haider")) %>% 
      bind_rows(allaffiliations %>% 
                  filter(Name=="Pavel Shirokikh")) %>% 
  ##
    bind_rows(optins) %>% 
